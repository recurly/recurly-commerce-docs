    ...
    <div className="flex justify-start">
      <div className="rounded-md p-6 m-4 max-w-lg shadow-md border border-gray-300 dark:bg-gray-800 dark:border-gray-600">
        ...
        <p>
          ...
          You must have Shopify admin access with refund permissions.
        </p>
        <p>
          <i className="fa-solid fa-exclamation-triangle mr-4" />
          Refunds cannot be issued in Recurly Commerce; all refunds happen in Shopify.
        </p>
      </div>
    </div>
  );
...
<Image align="center" className="border" border={true} width="80% " src="https://files.readme.io/2b190176b71dd049d963014b10c2ca08f3d126ba98ce31989bd529d9fa1e4078-1.gif" />
...
<Image align="center" className="border" border={true} width="80% " src="https://files.readme.io/c0a8ddb0174d52ba226b2acd7fceedace91f37e6add36c297c2de42b1f71b4b2-2.gif" />