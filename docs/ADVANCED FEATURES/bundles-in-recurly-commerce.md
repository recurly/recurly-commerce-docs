...
<HTMLBlock>{`
<script src="https://fast.wistia.com/player.js" async></script><script src="https://fast.wistia.com/embed/qu346qhiwv.js" async type="module"></script><style>wistia-player[media-id='qu346qhiwv']:not(:defined) { background: center / contain no-repeat url('https://fast.wistia.com/embed/medias/qu346qhiwv/swatch'); display: block; filter: blur(5px); padding-top:46.04%; }</style> <wistia-player media-id="qu346qhiwv" aspect="2.171945701357466"><div class="wistia_preload_transcript_outer_wrapper" style="width: 100%; height: 100%; display:flex; justify-content:center; align-items: center; margin-top:-46.04%;"><div class="wistia_preload_transcript_inner_wrapper" style=" overflow: auto;"><p class="wistia_preload_transcript_text" aria-hidden="true" tabindex="-1" style="text-align: justify; font-size: 5px !important;">Hello. We're very excited to demonstrate an exciting feature within Recurly Commerce called bundles. This is a fantastic way for you to offer a collection of products, but allow your customer to pick and choose and customize that bundle. It is very easy to purchase just like you do anything else with anything else in the Shopify store. And then your customers can come in at any time and make changes as desired. So let me go ahead and demonstrate that from the customer perspective. As a customer, I would come to the bundle product within your Shopify store. I can pick and choose as many products as I like. In this case, I'll go ahead and pick six different products from the collections that you have offered. So in this case, as a customer, I can see the different products, the price that I will pay, and then I can go ahead and add that subscription and then checkout. So very easy to make the purchase. I, as a customer, was able to pick and choose something that I like in that customized bundle. And then once it's purchased, I can log in my customer portal at any time as a customer. I can do various actions such as skipping or changing the frequency. But if I want to make any changes to that bundle, that's also very easy. I would click edit here, see that same familiar interface, and I can go ahead and for example, reduce the amount of pumpkin treats and maybe add in the sushi snaps and then make that update. So very easy as a customer to make those changes. Also, another nice thing as a merchant too is that you can offer a fixed price bundle. So say for example, you want them to always select six, you can do that too, and you can predefine the price. You can also allow your customers to switch between different fixed bundles. So lots of options as a merchant. The idea of being here is very easy for your customer to pick and choose and to customize with the overall goal of ideally leading to longer retention on that subscription and then a higher average order value as they add more products. So please check out the bundles feature when you can.</p></div></div></wistia-player>
`}</HTMLBlock>
